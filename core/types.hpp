...
namespace hft::core {
    ...
    struct alignas(64) MessageView {
        ...
        MessageView(const uint8_t* d, uint32_t len, Timestamp ts, uint32_t seq) noexcept
    ...
    struct alignas(64) NormalizedMessage {
        ...
        NormalizedMessage() noexcept
            : type(Type::UNKNOWN), instrument_id(0), order_id(0), price(0), quantity(0), side(0), timestamp(0), local_timestamp(0), sequence(0) {}
    };
